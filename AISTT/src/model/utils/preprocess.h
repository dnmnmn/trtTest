...
public:
    ...
    void* gpu_preprocess(unsigned char* src, float* dst, int height, int width, int channel);
    void gpu_resize(float* src, float* dst, int _height, int _width, int _channel);
    void gpu_resize(uchar* src, uchar* dst, int _height, int _width, int _channel);
    void gpu_nhwc_bgr_to_nchw_rgb(uchar* src, float* dst, int _height, int _width, int _channel, cudaStream_t _stream);
    void gpu_nhwc_bgr_to_nchw_rgb(float* src, float* dst, int _height, int _width, int _channel, cudaStream_t _stream);
