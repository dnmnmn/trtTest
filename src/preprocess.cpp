...
//    resize_image = new cv::Mat(height, width, CV_32FC3);
//    hwc_image = new cv::Mat(height, width, CV_32FC3);
//    chw_image = new cv::Mat(height, width, CV_32FC3);
//    rgb_image = new cv::Mat(org_height, org_width, CV_8UC3);
//    normalize_image = new cv::Mat(org_height, org_width, CV_32FC3);
//    crop_image = new cv::Mat(640, 640, CV_32FC3);
//    crop_chw_image = new cv::Mat(640, 640, CV_32FC3);
